...
public class CustomerBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3109119182559853860L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerBalance\",\"namespace\":\"com.example.kafkaDemo.schemas\",\"fields\":[{\"name\":\"accountId\",\"type\":\"string\"},{\"name\":\"customerId\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"balanceAmount\",\"type\":\"float\"}]}");
   ...
   */
  public CustomerBalance(java.lang.CharSequence accountId, java.lang.CharSequence customerId, java.lang.CharSequence name, java.lang.Float balanceAmount) {
   ...
   */
  public static com.example.kafkaDemo.schemas.CustomerBalance.Builder newBuilder() {
    return new com.example.kafkaDemo.schemas.CustomerBalance.Builder();
  }
   ...
   * @return A new CustomerBalance RecordBuilder
   */
  public static com.example.kafkaDemo.schemas.CustomerBalance.Builder newBuilder(com.example.kafkaDemo.schemas.CustomerBalance.Builder other) {
    if (other == null) {
      return new com.example.kafkaDemo.schemas.CustomerBalance.Builder();
    } else {
      return new com.example.kafkaDemo.schemas.CustomerBalance.Builder(other);
    }
  }
   ...
   * @return A new CustomerBalance RecordBuilder
   */
  public static com.example.kafkaDemo.schemas.CustomerBalance.Builder newBuilder(com.example.kafkaDemo.schemas.CustomerBalance other) {
    if (other == null) {
      return new com.example.kafkaDemo.schemas.CustomerBalance.Builder();
    } else {
      return new com.example.kafkaDemo.schemas.CustomerBalance.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerBalance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafkaDemo.schemas.CustomerBalance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafkaDemo.schemas.CustomerBalance other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.accountId)) {
        this.accountId = data().deepCopy(fields()[0].schema(), other.accountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder setAccountId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder setCustomerId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder setBalanceAmount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaDemo.schemas.CustomerBalance.Builder clearBalanceAmount() {
